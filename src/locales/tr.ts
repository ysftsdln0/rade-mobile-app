...
export const tr: TranslationKeys = {
  ...
  chatbot: {
    ...
    you: "Siz",
    greeting:
      "Merhaba! Ben RADE destek asistanıyım. Size bugün nasıl yardımcı olabilirim?",
    ...
    botResponse:
      "{topic} konusunda size yardımcı olacağım. Lütfen daha fazla ayrıntı verin.",
    serverIdRequest:
      "Bunu duyduğuma üzüldüm. Lütfen sunucu kimliğinizi verebilir misiniz?",
  },
