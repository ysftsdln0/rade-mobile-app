    ...
    <View style={{ flex: 1, backgroundColor: themeColors.background }}>
      ...
      <AppCard style={styles.card}>
        <View style={styles.headerRow}>
          <View>
            <Text style={[styles.title, { color: themeColors.text }]}>Destek Merkezi</Text>
            <Text style={[styles.subtitle, { color: themeColors.textSecondary }]}>Sorularınızı hızlıca iletin, ekibimiz yardımcı olsun.</Text>
          </View>
          <TouchableOpacity
      ...
      <AppCard style={styles.card}>
        <Text style={[styles.sectionTitle, { color: themeColors.text }]}>Durum Özeti</Text>
        <View style={styles.statsRow}>
          <StatBox label="Toplam" value={stats.total} color={themeColors.primary} />
      ...
      <AppCard style={styles.card} onPress={() => navigation.navigate('TicketList')}>
        <View style={styles.linkRow}>
          <View>
            <Text style={[styles.linkTitle, { color: themeColors.text }]}>Bilet Listesi</Text>
            <Text style={[styles.linkSubtitle, { color: themeColors.textSecondary }]}>Tüm destek taleplerinizi görüntüleyin</Text>
          </View>
      ...
      <AppCard style={styles.card} onPress={() => navigation.navigate('Chatbot')}>
        <View style={styles.linkRow}>
          <View>
            <Text style={[styles.linkTitle, { color: themeColors.text }]}>Canlı Destek</Text>
            <Text style={[styles.linkSubtitle, { color: themeColors.textSecondary }]}>Müşteri temsilcimizle anında sohbet edin</Text>
          </View>
          <Ionicons name="chevron-forward" size={22} color={themeColors.textSecondary} />
        </View>
      </AppCard>
