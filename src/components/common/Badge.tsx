...
const variantColors: Record<BadgeVariant, { bg: string; text: string }> = {
  ...
  success: { bg: `${colors.semantic.success}15`, text: colors.semantic.success },
  warning: { bg: `${colors.semantic.warning}15`, text: colors.semantic.warning },
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  return (
    <View style={[styles.badge, sizeStyles.container, { backgroundColor: variantStyle.bg }, style]}>
